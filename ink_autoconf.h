/* lib/ink_autoconf.h.  Generated from ink_autoconf.h.in by configure.  */
/* lib/ink_autoconf.h.in.  Generated from configure.ac by autoheader.  */
...
/* Define to 1 if you have the <google/profiler.h> header file. */
/* #undef HAVE_GOOGLE_PROFILER_H */

/* Define to 1 if you have the `hcreate_r' function. */
#define HAVE_HCREATE_R 1
...
/* Define to 1 if you have Expat library */
/* #undef HAVE_LIBEXPAT */
...
/* Define to 1 if you have the `SSL_CTX_set_next_protos_advertised_cb'
   function. */
#define HAVE_SSL_CTX_SET_NEXT_PROTOS_ADVERTISED_CB 1
...
#define HAVE_SSL_GET0_NEXT_PROTO_NEGOTIATED 1

/* Define to 1 if you have the `SSL_get_servername' function. */
#define HAVE_SSL_GET_SERVERNAME 1

/* Define to 1 if you have the `SSL_select_next_proto' function. */
#define HAVE_SSL_SELECT_NEXT_PROTO 1
...
/* whether std::shared_ptr is available */
...
#define PACKAGE_STRING "Apache Traffic Server 6.2.2"
